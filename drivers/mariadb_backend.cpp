...
/***************************************************************
 * @file        mariadb_backend.cpp
 * @author      waters
 * @version     1.0.0
 * @date        2022/8/24 15:58
 * @brief       database Mariadb backend
 **************************************************************/
    ...
    namespace mariadb_backend {
        ...
        public:
                    ...
                    conn_(0)
            {
                conn_ = mysql_init(0);
                if(!conn_) {
                    throw cppdb_error("cppdb::mariadb failed to create connection");
                }
...
extern "C" {
CPPDB_DRIVER_API cppdb::backend::connection *cppdb_mariadb_get_connection(cppdb::connection_info const &cs)
{
return new cppdb::mariadb_backend::connection(cs);
}
}
